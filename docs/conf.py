...
"""
platform_plugin_hyperpay documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform_plugin_hyperpay',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/nelc/platform_plugin_hyperpay",
...
#
# html_title = 'platform_plugin_hyperpay v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Openedx plugin to add hyperpay payment processor',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_hyperpay'),
                os.path.join(root_path, 'platform_plugin_hyperpay/migrations')])
