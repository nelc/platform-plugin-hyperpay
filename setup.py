#!/usr/bin/env python
"""
Package metadata for platform_plugin_hyperpay.
"""
import os
import re
import sys
...
VERSION = get_version('platform_plugin_hyperpay', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""Openedx plugin to add hyperpay payment processor""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Nelc',
    author_email='nelc-team@edunext.co',
    url='https://github.com/nelc/platform_plugin_hyperpay',
    packages=find_packages(
        include=['platform_plugin_hyperpay', 'platform_plugin_hyperpay.*'],
        exclude=["*tests"],
    ),
